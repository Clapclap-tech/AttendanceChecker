...
export default function GoogleClassroomClone({ customStyles = {}, initialActiveView = null, userData, onJoinClass = () => {}, onCreateClass = () => {} }) {
  ...
  const handleCreateClass = () => {
    if (className.trim().length > 0) {
      onCreateClass({ name: className, section, subject, room });
      closeView();
    }
  };
